...
function App() {
  ...
  return (
    ...
    <p>I am Navya Sree , studying B-Tech final year at Bhoj Reddy Engineering College for Women in the field of Information Technology. 
      ...
      <ul> 
        <li>10th : Rau's High School with 9.7 cgpa</li>
        <li>Diploma : Government Polytechnic For Women Secunderabad with 9.7 cgpa</li>
        <li>B-Tech : Bhoj Reddy Engineering College for Women with 8.6 cgpa </li>
      </ul>
    </> 
  )
}
